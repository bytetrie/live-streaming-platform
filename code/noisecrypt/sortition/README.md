...
This project is a component of _noisecrypt. The component provides the ability
to redirect requests to a random selection from a set of URLs. The URLs are
generally sludge endpoints. A hub is created using the UI, and this can then be
used in sludge to add/remove endpoints to the hub, or in syllid to fetch random
